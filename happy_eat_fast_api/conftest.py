...
from happy_eat_fast_api.db.dependencies import get_db_session
from happy_eat_fast_api.db.utils import create_database, drop_database
from happy_eat_fast_api.services.kafka.dependencies import get_kafka_producer
from happy_eat_fast_api.services.kafka.lifetime import init_kafka, shutdown_kafka
from happy_eat_fast_api.services.rabbit.dependencies import get_rmq_channel_pool
from happy_eat_fast_api.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from happy_eat_fast_api.services.redis.dependency import get_redis_pool
from happy_eat_fast_api.settings import settings
from happy_eat_fast_api.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from happy_eat_fast_api.db.meta import meta  # noqa: WPS433
    from happy_eat_fast_api.db.models import load_all_models  # noqa: WPS433
